...
model.add (Conv2D(filters=128 , kernel_size=3, padding='same', acivation= 'relu'))
...
# output layer
model.add(Dense(unitss=38 , activation ='softmax'))
...
# training_history.history['val_accuaracy']
